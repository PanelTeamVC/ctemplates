...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '', title: 'Campaña 12', icon: 'ft-zap', class: 'nav-item has-sub', badge: '', badgeClass: '', isExternalLink: false, isNavHeader: false,
        submenu: [
            { path: '/components/models', title: 'Semana 1', icon: '', class: 'menu-item', badge: '', badgeClass: '', isExternalLink: false, isNavHeader: false, submenu: [] },
            { path: '/semana-2', title: 'Semana 2', icon: '', class: 'menu-item', badge: '', badgeClass: '', isExternalLink: false, isNavHeader: false, submenu: [] },
            // {
    ...
    {
        path: '', title: 'Campaña 13', icon: 'ft-zap', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false, isNavHeader: false,
        submenu: [        
            { path: '/components/accordion', title: 'Semana 1', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, isNavHeader: false, submenu: [] },   
            { path: '/components/alerts', title: 'Semana 2', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, isNavHeader: false, submenu: [] },
